...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="/hopeui/assets/images/favicon.ico" />

      <!-- Library / Plugin Css Build -->
      <link rel="stylesheet" href="/hopeui/assets/css/core/libs.min.css" />

      <!-- Aos Animation Css -->
      <link rel="stylesheet" href="/hopeui/assets/vendor/aos/dist/aos.css" />

      <!-- Hope Ui Design System Css -->
      <link rel="stylesheet" href="/hopeui/assets/css/hope-ui.min.css?v=2.0.0" />

      <!-- Custom Css -->
      <link rel="stylesheet" href="/hopeui/assets/css/custom.min.css?v=2.0.0" />

      <!-- Dark Css -->
      <link rel="stylesheet" href="/hopeui/assets/css/dark.min.css"/>

      <!-- Customizer Css -->
      <link rel="stylesheet" href="/hopeui/assets/css/customizer.min.css" />

      <!-- RTL Css -->
      <link rel="stylesheet" href="/hopeui/assets/css/rtl.min.css"/>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Data Klinik</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-special" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <span class="item-name">Dokter</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/dokter">
                                  ...
                                  <span class="item-name">Tampil Data</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/dokter/create">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/dokter/laporan/cetak">
                                   <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                   ...
                                   <span class="item-name">Laporan Dokter</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/pasien/laporan/cetak">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">Laporan Pasien</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/administrasi/laporan/cetak">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Laporan Administrasi</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Profil</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/tentang">
                            ...
                            <span class="item-name">Tentang</span>
                        </a>
                    </li>
                </ul>
                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">Farhan Wahyudi</h6>
                        <p class="mb-0 caption-sub-title">Mahasiswa</p>
                    </div>
                  </a>
...
<br>
      ...
      <footer class="footer">
          <div class="footer-body">
              ...
              <div class="right-panel">
                ©<script>document.write(new Date().getFullYear())</script> Using Hope UI Template, Made with
                <span class="">
                ...
                </span> by <a href="https://iqonic.design/">Farhan Wahyudi</a>.
              </div>
          </div>
      </footer>
          ...
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="text-center">
                <img src="/hopeui/assets/images/settings/dark/01.png" alt="ltr" class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="dir-mode" data-name="dir" data-value="ltr">
                <img src="/hopeui/assets/images/settings/light/01.png" alt="ltr" class="mode light-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="dir-mode" data-name="dir" data-value="ltr">
                <span class=" mt-2"> LTR </span>
              </div>
               <div class="text-center">
                 <img src="/hopeui/assets/images/settings/dark/02.png" alt="" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="dir-mode" data-name="dir" data-value="rtl">
                  <img src="/hopeui/assets/images/settings/light/02.png" alt="" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="dir-mode" data-name="dir" data-value="rtl">
            ...
            <div class="d-grid gap-3 grid-cols-3 mb-4">
              <div class="text-center">
                <img src="/hopeui/assets/images/settings/dark/03.png" alt="mini" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                <img src="/hopeui/assets/images/settings/light/03.png" alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                <span class="mt-2">Mini</span>
              </div>
              <div class="text-center">
               <img src="/hopeui/assets/images/settings/dark/04.png" alt="hover" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
               <img src="/hopeui/assets/images/settings/light/04.png" alt="hover" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                <span class="mt-2">Hover</span>
              </div>
              <div class="text-center">
                 <img src="/hopeui/assets/images/settings/dark/05.png" alt="boxed" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
                 <img src="/hopeui/assets/images/settings/light/05.png" alt="boxed" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
            ...
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="text-center">
                <img src="/hopeui/assets/images/settings/dark/06.png" alt="rounded-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                <img src="/hopeui/assets/images/settings/light/06.png" alt="rounded-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                <span class="mt-2">Rounded One Side</span>
              </div>
              <div class="text-center">
                <img src="/hopeui/assets/images/settings/dark/07.png" alt="rounded-all" class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                <img src="/hopeui/assets/images/settings/light/07.png" alt="rounded-all" class="mode light-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                <span class="mt-2">Rounded All</span>
              </div>
              <div class="text-center">
                 <img src="/hopeui/assets/images/settings/dark/08.png" alt="pill-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                 <img src="/hopeui/assets/images/settings/light/09.png" alt="pill-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                <span class="mt-2">Pill One Side</span>
              </div>
              <div class="text-center">
                 <img src="/hopeui/assets/images/settings/dark/09.png" alt="pill-all" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
    ...
    <script src="/hopeui/assets/js/core/libs.min.js"></script>

    <!-- External Library Bundle Script -->
    <script src="/hopeui/assets/js/core/external.min.js"></script>

    <!-- Widgetchart Script -->
    <script src="/hopeui/assets/js/charts/widgetcharts.js"></script>

    <!-- mapchart Script -->
    <script src="/hopeui/assets/js/charts/vectore-chart.js"></script>
    <script src="/hopeui/assets/js/charts/dashboard.js" ></script>

    <!-- fslightbox Script -->
    <script src="/hopeui/assets/js/plugins/fslightbox.js"></script>

    <!-- Settings Script -->
    <script src="/hopeui/assets/js/plugins/setting.js"></script>

    <!-- Slider-tab Script -->
    <script src="/hopeui/assets/js/plugins/slider-tabs.js"></script>

    <!-- Form Wizard Script -->
    <script src="/hopeui/assets/js/plugins/form-wizard.js"></script>

    <!-- AOS Animation Plugin-->
    <script src="/hopeui/assets/vendor/aos/dist/aos.js"></script>

    <!-- App Script -->
    <script src="/hopeui/assets/js/hope-ui.js" defer></script>
